...
public class profile extends Fragment {
    ...
    Button buttonprof, buttonlogout, buttonabout, buttontutor, buttonmap, buttonchat;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        buttonmap = getActivity().findViewById(R.id.btnmaps);
        ...
        String imgurl = "http://192.168.1.10/new%20folder/" + sharedPreferences.getString("path", "");
